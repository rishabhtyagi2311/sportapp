...
export default function DemoRequestsScreen() {
  ...
  const { bookings, isLoading, fetchDemoBookings, confirmDemoBooking, completeDemoBooking, cancelDemoBooking } =
    useDemoBookingStore();
        ...
        <View className="flex-row items-start justify-between mb-3">
          <View className="flex-1">
            ...
            <Text className="text-slate-500 text-xs mt-1">
              Parent: {item.fatherName || "—"} {item.fatherContact ? `• ${item.fatherContact}` : ""}
            </Text>
          </View>
