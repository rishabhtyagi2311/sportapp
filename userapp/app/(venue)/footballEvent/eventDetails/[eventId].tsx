                            ...
                            <View>
                                ...
                                {captainTeams.map((team) => (
                                    <TouchableOpacity
                                        ...
                                        className={`p-5 rounded-3xl mb-4 border-2 flex-row items-center justify-between ${selectedTeam?.id === team.id
                                                ? 'bg-slate-900 border-slate-900 shadow-lg shadow-black/20'
                                                : 'bg-white border-slate-100'
                                            }`}
                                    >
                                        <View className="flex-1">
                                            <Text
                                                className={`font-black text-lg ${selectedTeam?.id === team.id ? 'text-white' : 'text-slate-900'
                                                    }`}
                                            >
                                                {team.teamName}
                                            </Text>
                                            <Text
                                                className={`text-xs mt-1 font-medium ${selectedTeam?.id === team.id ? 'text-slate-200' : 'text-slate-400'
                                                    }`}
                                            >
                                ...
                                >
                                    <View className="bg-slate-900 py-5 rounded-3xl flex-row items-center justify-center">
